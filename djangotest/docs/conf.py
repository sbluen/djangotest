...
texinfo_documents = [
  ('index', 'djangoproject', u'djangoproject Documentation',
   u'Steven Bluen', 'djangoproject', 'One line description of project.',
   'Miscellaneous'),
]
...
#source: http://stackoverflow.com/questions/5599254/how-to-use-sphinxs-autodoc-to-document-a-classs-init-self-method
